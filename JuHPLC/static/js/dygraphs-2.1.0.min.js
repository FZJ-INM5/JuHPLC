    ...
    return function t(e, a, i) {
                    ...
                    for (r = 0; r < t.length; r++) {
                        ...
                        if (h)
                            if (d) {
                                var g = p < 0 ? 0 : p,
                                    f = d,
                                    _ = l * Math.sqrt(g * (1 - g) / f + l * l / (4 * f * f)),
                                    v = 1 + l * l / d;
                                i = (g + l * l / (2 * d) - _) / v, n = (g + l * l / (2 * d) + _) / v, s[r] = [c, 100 * g, [100 * i, 100 * n]]
                            } else s[r] = [c, 0, [0, 0]];
                        else o = d ? l * Math.sqrt(p * (1 - p) / d) : 1, s[r] = [c, 100 * p, [100 * (p - o), 100 * (p + o)]]
                    }
                    return s
                }, a.default = r, e.exports = a.default
            }, {
        ...
        5: [
            function (t, e, a) {
                ...
                l.prototype = new r.default, l.prototype.extractSeries = function (t, e, a) {
                    ...
                    for (var i, n = null, r = null, o = t.length - 1, s = 0; s <= o; s++)
            ...
            function (t, e, a) {
                ...
                s.prototype.clear = function () {
                    ...
                    for (var _ = e.array_, v = e.end_, y = e.predicate_, x = e.start_; x < v; x++) {
                        ...
                        if (null === h.canvasy || h.canvasy != h.canvasy) o && null !== u && (f.moveTo(u, d), f.lineTo(h.canvasx, d)), u = d = null;
                        else {
                            if (l = !1, r || null === u) {
                    ...
                    for (a = 0; a < h.length; a++)
                        for (var c = h[a], p = a == h.length - 1, g = 0; g < o.length; g++)
                            if (i = s[g], !t || i == t) {
                                var f = o[g],
                                    _ = c;
                                if (i in u) {
        ...
        12: [
            function (t, e, a) {
                ...
                r.maybeTreatMouseOpAsClick = function (t, e, a) {
                    ...
                    var r = i + a.dateRange;
                    if (a.boundedDates && r > a.boundedDates[1] && (i -= r - a.boundedDates[1], r = i + a.dateRange), e.getOptionForAxis("logscale", "x") ? e.dateWindow_ = [Math.pow(n.LOG_SCALE, i), Math.pow(n.LOG_SCALE, r)] : e.dateWindow_ = [i, r], a.is2DPan)
                        for (var o = a.dragEndY - a.dragStartY, s = 0; s < e.axes_.length; s++) {
                            var l = e.axes_[s],
                                h = a.axes[s],
                                u = o * h.unitsPerPixel,
                    ...
                    var _ = !1;
                    if (a.touchDirections.x && (e.dateWindow_ = [l.dataX - h.dataX + (a.initialRange.x[0] - l.dataX) / c, l.dataX - h.dataX + (a.initialRange.x[1] - l.dataX) / c], _ = !0), a.touchDirections.y)
                        for (i = 0; i < 1; i++) {
                            var v = e.axes_[i],
            ...
            function (t, e, a) {
                ...
                r.prototype.addDataset = function (t, e) {
                    ...
                    for (this.yticks = [], t = 0; t < this.yAxes_.length; t++)
                        for (var o = this.yAxes_[t], s = 0; s < o.ticks.length; s++) e = o.ticks[s], a = e.label, r = !("label_v" in e), n = r ? e.v : e.label_v, (i = this.dygraph_.toPercentYCoord(n, t)) > 0 && i <= 1 && this.yticks.push({
                            axis: t,
                            pos: i,
                            label: a,
                            has_tick: r
        ...
        16: [
            function (t, e, a) {
                ...
                var o = function (t, e, a, i, r, o) {
                    var s, l, h, u, c = i("pixelsPerLabel"),
                        p = [];
                    if (o)
                        for (s = 0; s < o.length; s++) p.push({
                            v: o[s]
                        });
                    else {
                        if (i("logscale")) {
                        ...
                        if (0 === p.length) {
                            ...
                            for (D > E && (O *= -1), s = 0; s <= u; s++) h = D + s * O, p.push({
                                v: h
                            })
                        }
                    }
                ...
                var d = function () {
                    ...
                    c = function (t, e, a, i) {
                        ...
                        var x = [],
                            ...
                            b = m.getTime();
                        if (a <= l.HOURLY)
                            for (b < t && (b += g, m = new Date(b)); b <= e;) x.push({
                                v: b,
                                label: o.call(r, m, a, i, r)
                            }), b += g, m = new Date(b);
                        else
                            for (b < t && (_[c] += p, m = d.makeDate.apply(null, _), b = m.getTime()); b <= e;) (a >= l.DAILY || d.getHours(m) % p == 0) && x.push({
                                v: b,
                                label: o.call(r, m, a, i, r)
        ...
        17: [
            function (t, e, a) {
                ...
                function w(t, e) {
                    if (void 0 !== e && null !== e)
                        for (var a in e) e.hasOwnProperty(a) && (null === e[a] ? t[a] = null : A(e[a]) ? t[a] = e[a].slice() : !function (t) {
                ...
                function C(t, e) {
                    var a = {};
                    if (t)
                        for (var i = 1; i < t.length; i++) a[t[i]] = !0;
                    var n = function (t) {
                        for (var e in t)
                ...
                function Y(t, e) {
                    ...
                    if (i = 0 !== t && (Math.abs(t) >= Math.pow(10, r) || Math.abs(t) < Math.pow(10, -n)) ? t.toExponential(n) : "" + v(t, n), o || s) {
                        ...
                        for (var d = Math.abs(t), c = F(l, h.length), g = h.length - 1; g >= 0; g--, c /= l)
                            if (d >= c) {
                                i = v(t / c, n) + h[g];
                                break
                            }
            ...
            function (t, e, a) {
                (function (i) {
                    ...
                    Q.NAME = "Dygraph", Q.VERSION = "2.1.0", Q.DEFAULT_ROLL_PERIOD = 1, Q.DEFAULT_WIDTH = 480, Q.DEFAULT_HEIGHT = 320, Q.ANIMATION_STEPS = 12, Q.ANIMATION_DURATION = 200, Q.Plotters = d.default._Plotters, Q.addedAnnotationCSS = !1, Q.prototype.__init__ = function (t, e, a) {
                        ...
                        this.removeTrackedEvents_(), x.removeEvent(window, "mouseout", this.mouseOutHandler_), x.removeEvent(this.mouseEventElement_, "mousemove", this.mouseMoveHandler_), x.removeEvent(window, "resize", this.resizeHandler_), this.resizeHandler_ = null,
                            function t(e) {
                        ...
                        for (var a = this.getNumericOption("colorSaturation") || 1, i = this.getNumericOption("colorValue") || .5, n = Math.ceil(e / 2), r = this.getOption("colors"), o = this.visibility(), s = 0; s < e; s++)
                            if (o[s]) {
                                var l = t[s + 1],
                        ...
                        var r, o, s = this,
                            ...
                            u = [];
                        if (null !== t && null !== e)
                            for (r = 1; r <= l; r++) o = Q.zoomAnimationFunction(r, l), h[r - 1] = [t[0] * (1 - o) + o * e[0], t[1] * (1 - o) + o * e[1]];
                        if (null !== a && null !== i)
                            for (r = 1; r <= l; r++) {
                        ...
                        for (var a, i, n, r, o, s, l, h = 1 / 0, u = this.layout_.points.length - 1; u >= 0; --u)
                            for (var d = this.layout_.points[u], c = 0; c < d.length; ++c) r = d[c], x.isValidPoint(r) && (i = r.canvasx - t, n = r.canvasy - e, (a = i * i + n * n) < h && (h = a, o = r, s = u, l = r.idx));
                        return {
                            row: l,
                        ...
                        var t, e, a;
                        for (this.axes_ = [], t = 0; t < this.attributes_.numAxes(); t++) e = {
                            g: this
                        }, x.update(e, this.attributes_.axisOptions(t)), this.axes_[t] = e;
                        for (t = 0; t < this.axes_.length; t++)
                            if (0 === t) e = this.optionsViewForAxis_("y" + (t ? "2" : "")), (a = e("valueRange")) && (this.axes_[t].valueRange = a);
                            else {
                        ...
                        for (var e, a, i, n, r, o = function (t) {
                            ...
                            if (null !== p && (e = !1, n = p / this.plotter_.area.h), 0 === i.length) h.extremeRange = [0, 1];
                            else {
                        ...
                        for (var l, h = !1, u = this.attr_("labels").length, d = !1, c = s; c < r.length; c++) {
                            ...
                            if (c, 0 !== p.length && "#" != p[0]) {
                                ...
                                if (!(g.length < 2)) {
                                    var f = [];
                                    if (h || (this.detectTypeFromString_(g[0]), l = this.getFunctionOption("xValueParser"), h = !0), f[0] = l(g[0], this), this.fractions_)
                                        for (a = 1; a < g.length; a++) e = g[a].split("/"), 2 != e.length ? (console.error('Expected fractional "num/den" values in CSV data but found a value \'' + g[a] + "' on line " + (1 + c) + " ('" + p + "') which is not of this form."), f[a] = [0, 0]) : f[a] = [x.parseFloat_(e[0], c, p), x.parseFloat_(e[1], c, p)];
                                    else if (this.getBooleanOption("errorBars"))
                                        for (g.length % 2 != 1 && console.error("Expected alternating (value, stdev.) pairs in CSV data but line " + (1 + c) + " has an odd number of values (" + (g.length - 1) + "): '" + p + "'"), a = 1; a < g.length; a += 2) f[(a + 1) / 2] = [x.parseFloat_(g[a], c, p), x.parseFloat_(g[a + 1], c, p)];
                                        ...
                                        for (a = 1; a < g.length; a++) f[a] = x.parseFloat_(g[a], c, p);
                        ...
                        var e = t.getNumberOfColumns(),
                            a = t.getNumberOfRows(),
                            i = t.getColumnType(0);
                        if ("date" == i || "datetime" == i) this.attrs_.xValueParser = x.dateParser, this.attrs_.axes.x.valueFormatter = x.dateValueFormatter, this.attrs_.axes.x.ticker = v.dateTicker, this.attrs_.axes.x.axisLabelFormatter = x.dateAxisLabelFormatter;
                        else {
                        ...
                        for (n = 0; n < a; n++) {
                            ...
                            if (void 0 !== t.getValue(n, 0) && null !== t.getValue(n, 0)) {
                                if ("date" == i || "datetime" == i ? f.push(t.getValue(n, 0).getTime()) : f.push(t.getValue(n, 0)), this.getBooleanOption("errorBars"))
                                    for (r = 0; r < e - 1; r++) f.push([t.getValue(n, 1 + 2 * r), t.getValue(n, 2 + 2 * r)]);
                                else {
                        ...
                        var t = this.file_;
                        if ("function" == typeof t && (t = t()), x.isArrayLike(t)) this.rawData_ = this.parseArray_(t), this.cascadeDataDidUpdateEvent_(), this.predraw_();
                        ...
                        var a = this.visibility(),
                            i = !1;
                        if (Array.isArray(t) || (null !== t && "object" == typeof t ? i = !0 : t = [t]), i)
                            for (var n in t) t.hasOwnProperty(n) && (n < 0 || n >= a.length ? console.warn("Invalid series number in setVisibility: " + n) : a[n] = t[n]);
                        else
                            for (var n = 0; n < t.length; n++) "boolean" == typeof t[n] ? n >= a.length ? console.warn("Invalid series number in setVisibility: " + n) : a[n] = t[n] : t[n] < 0 || t[n] >= a.length ? console.warn("Invalid series number in setVisibility: " + t[n]) : a[t[n]] = e;
                        this.predraw_()
                        ...
                        x.addEvent(t, e, a), this.registeredEvents_.push({
                            elem: t,
                            type: e,
                            fn: a
                        })
                    ...
                    }, Q.PLUGINS = [U.default, X.default, j.default, Z.default, H.default, G.default
                    ], Q.GVizChart = q.default, Q.DASHED_LINE = x.DASHED_LINE, Q.DOT_DASH_LINE = x.DOT_DASH_LINE, Q.dateAxisLabelFormatter = x.dateAxisLabelFormatter, Q.toRGB_ = x.toRGB_, Q.findPos = x.findPos, Q.pageX = x.pageX, Q.pageY = x.pageY, Q.dateString_ = x.dateString_, Q.defaultInteractionModel = f.default.defaultModel, Q.nonInteractiveModel = Q.nonInteractiveModel_ = f.default.nonInteractiveModel_, Q.Circles = x.Circles, Q.Plugins = {
                        Legend: U.default,
                        Axes: X.default,
        ...
        20: [
            function (t, e, a) {
                ...
                i.prototype.toString = function () {
                    ...
                    if (a && 0 !== a.length)
                        for (var i = t.canvas.parentNode, n = function (t, a, i) {
                            return function (n) {
                                var r = i.annotation;
        ...
        24: [
            function (t, e, a) {
                ...
                function i(t, e, a) {
                    ...
                    var d = "";
                    for (n = 0; n < s; n++)
                        for (i = 0; i < h; i += 2) r = u[i % u.length], o = i < t.length ? u[(i + 1) % u.length] : 0, d += '<div class="dygraph-legend-dash" style="margin-right: ' + o + "em; padding-left: " + r + 'em;"></div>';
                    return d
                }
                ...
                o.prototype.select = function (t) {
                    ...
                    if (void 0 !== e) {
                        ...
                        for (c = 0; c < a.length; c++) {
                            var w = a[c],
                                f = u[w.name];
                            if (f.y = w.yval, 0 === w.yval && !m || isNaN(w.canvasy)) f.isVisible = !1;
                            else {
        ...
        25: [
            function (t, e, a) {
                ...
                u.prototype.toString = function () {
                    ...
                    this.createCanvases_(), this.createZoomHandles_(), this.initInteraction_(), this.getOption_("animatedZooms") && (console.warn("Animated zooms and range selector are not compatible; disabling animatedZooms."), this.dygraph_.updateOptions({
                        animatedZooms: !1
                    ...
                    var t, e, a, i, n, o, l, u, d, c, p, g, f, _, v = this,
                        y = document,
                        x = 0,
                        m = null,
                        b = !1,
                    ...
                    if (t || a) {
                        var i = this.getOption_("stepPlot"),
                            ...
                            h = (this.canvasRect_.w - .5) / l,
                            u = (this.canvasRect_.h - .5) / r,
                            d = this.canvasRect_.w - .5,
                            c = this.canvasRect_.h - .5,
                            p = null,
                            g = null;
                    ...
                    if (s)
                        for (t = 1; t < i; t++) o[t] = h[t - 1];
                    else
                        for (t = 1; t < i; t++) o[t] = l[t - 1];
                    var d = [],
                        c = e.dataHandler_,
                        p = e.attributes_;
                    ...
                    if (a)
                        for (b = r.log10(b), b += .25 * b, m = r.log10(m), t = 0; t < f.length; t++) f[t][1] = r.log10(f[t][1]);
                    else {
                        var A, O = b - m;
